...
- Plain markdown (`.md`) files will be styled according to the Theme chosen in settings.
- Create a file called `index.md` inside `/docs`, and it will appear as the landing page at `https://your-username.github.io/repo-name`.
- To make a personal website, the repo must be named `your-username.github.io`. 
  - e.g. here's mine: <https://github.com/kelly-sovacool/kelly-sovacool.github.io>
...
- Pat has a custom domain set up for the lab, so pages from repos in the `SchlossLab` GitHub Organization appear at `http://www.schlosslab.org/repo-name`.
  ...
  the source files are in [the `/docs` folder](https://github.com/SchlossLab/mikropml/tree/master/docs) of `github.com/SchlossLab/mikropml`.
